...
function Session({ session, focusDuration, breakDuration}) {
  ...
  return ( 
   session && (
   <div>
       {/* only shows when there is an active focus or break - i.e. the session is running or is paused */}
       <div className="row mb-2">
          <div className="col">
            {/* message includes current session (Focusing or On Break) total duration */}
